...
<section class="gweb-text-layout gweb-link-grey">
    <div class="content">
        <BackBreadcrum/>
        <h2><a href="projects/theherobrine">The Herobrine!</a> - 2023</h2>
        <p>
            The Herobrine! is my remake of an old Hive MC game-mode that was removed in their Java 2 update.
        </p>

        <h2><a href="projects/bubbletill">Bubbletill</a> - 2023</h2>
        <p>
        ...
        <h2><a href="/projects/surya">Surya Real Estate</a> - 2022</h2>
        <p>
        ...
        <h2><a href="/projects/isborisgone">Is Boris Gone?</a> - 2021</h2>
        <p>
