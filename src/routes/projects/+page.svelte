...
<section class="gweb-text-layout gweb-link-grey">
    <div class="content">
        ...
        <h3><b>/</b> <a href="projects/theherobrine">The Herobrine!</a> - 2023</h3>
        <p>
            The Herobrine! is my remake of an old Hive MC game-mode that was removed in their Java 2 update.
        </p>

        <h3><b>/</b> <a href="projects/bubbletill">Bubbletill</a> - 2023</h3>
        <p>
        ...
        <h3><b>/</b> <a href="/projects/surya">Surya Real Estate</a> - 2022</h3>
        <p>
        ...
        <h3><b>/</b> <a href="/projects/isborisgone">Is Boris Gone?</a> - 2021</h3>
        <p>
